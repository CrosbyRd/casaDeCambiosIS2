...
class DocumentoElectronico(models.Model):
    ...
    numero_documento = models.CharField(max_length=7, verbose_name="Número de Documento") # Ej: 0000101
    ...
    # Relación con Transacción (opcional, una factura puede no estar ligada directamente a una transacción)
    ...
    class Meta:
        ...
        # Asegurar que no se repita el número de documento para un mismo emisor, establecimiento y punto de expedición
        unique_together = ('emisor', 'numero_documento') # La API ya valida esto, pero es buena práctica a nivel de DB
...
class ItemDocumentoElectronico(models.Model):
    ...
    unidad_medida = models.CharField(max_length=5, default="77", verbose_name="Unidad de Medida") # cUniMed (Factura Segura solo soporta 77)
