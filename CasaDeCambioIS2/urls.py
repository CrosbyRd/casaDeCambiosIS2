...
from core.views import pagina_inicio_y_simulador  # simulador/calculadora
from . import views as site_views

urlpatterns = [
    # --- Público (dinámico) ---
    path("", site_views.site_home, name="home"),
    path("rates/", site_views.site_rates, name="site_rates"),
    ...
    # --- Autenticación (tu flujo OTP + logout) ---
    ...
    # --- Reset de contraseña (plantillas “registration/*”) ---
    path(
        "forgot-password/",
