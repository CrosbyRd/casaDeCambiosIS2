...
urlpatterns = [
    ...
    path('operacion/verificar-otp-compra-flotante/', views.VerificarOtpCompraFlotanteView.as_view(), name='verificar_otp_compra_flotante'),
    ...
    path('operacion/iniciada-aviso/<uuid:transaccion_id>/', views.OperacionIniciadaAvisoView.as_view(), name='operacion_iniciada_aviso'), # Nueva URL para el aviso de operación iniciada
